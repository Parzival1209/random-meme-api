...
On the website for this repository, you can find the URL to the API, along with additional information.<br>
<br>
...
The parameter format controls the format of the returned URL(s). The available formats are HTML, JSON, and plain text. Note that setting the format to HTML returns the HTML code for a simple webpage that shows a single randomly chosen meme **as text.**<br>
